<?php
/**
 * Template part for displaying sidebar content in category.php
 *
...
?>
		...
		<div class="card bg-white border-dark mb-3 rounded">
		    <div class="card-body">
			<h3 class="card-title"><?php esc_html_e( 'Tests in', 'gustumexlibro' ); echo ' '.$cat_name; ?></h3>
			<p class="card-text text-justify">
			    <?php
			    $stats_args = array(
				'cat' 	 => $cat_id
			    );
			    $cat_stats = new WP_Query( $stats_args );
			    printf( // WPCS: XSS OK.
				/* translators: 1: number of tests for a category, 2: category. */
				_nx( 'Tu Peux Pas Zeste tasted and tested <span class="font-weight-bold">%1$s</span> lemon meringue product for the category &laquo; %2$s &raquo;.', 'Tu Peux Pas Zeste tasted and tested <span class="font-weight-bold">%1$s</span> lemon meringue products during the category &laquo; %2$s &raquo;.', $cat_stats->post_count, 'number of tests for a category', 'gustumexlibro' ),
				$cat_stats->post_count,
				$cat_name
			    );
			    ?>
			</p>
		...
		<div class="card bg-white border-dark mb-3 rounded">
		    <div class="card-body">
			<h3 class="card-title"><?php esc_html_e( 'Top 20 in', 'gustumexlibro' ); echo ' '.ucfirst($cat_name); ?></h3>
